  ...
  def getvalues
    ...
    ############################################################
      ...
      begin
        ...
        metricsPass[metricsCount] = metrics[metricsCount] <= 4 && metrics[metricsCount] >= 2 && metrics[metricsNames.index("Zillow Comparable count")] > 6
        metricsComments[metricsCount]= "Bedrooms between 2 and 4 and 7+ Zillow comparables available"
      ...
      begin
        ...
        metricsPass[metricsCount] = metrics[metricsCount] <= 50 && metrics[metricsCount] >= -50
        metricsComments[metricsCount] = "SqFt must be within 50%"
        metricsUsage[metricsCount] = "Typicality"
      rescue Exception => e
        metricsNames[metricsCount] = "SqFt Typicality"
        metrics[metricsCount]= "N/A"
      ...
      begin
        ...
        metricsPass[metricsCount] = metrics[metricsCount] <= 50 && metrics[metricsCount] >= -50
        metricsComments[metricsCount]= "Zestimate must be within 50%"
        metricsUsage[metricsCount] = "Typicality"
      rescue Exception => e
        metricsNames[metricsCount] = "Zestimate Typicality"
        metrics[metricsCount]= "N/A"
    ...
    ############################################################
    #                                                          #
    #        Initial (Deprecated) tested typicality metrics    #
    #                                                          #
    ############################################################
    ...
    ############################################################
    #                                                          #
    #        Other (Deprecated) tested typicality metrics      #
    #                                                          #
    ############################################################
    ...
    ############################################################
      ...
      if (metricsPass[metricsNames.index("Urban Density")..metricsNames.index("Surrounding Census Tract Density")].count(false)) >= 1
        reason[1]="Too rural"
      else
        reason[1]=nil
      end
      if metricsPass[metricsNames.index("Bedrooms Typicality")..metricsNames.index("Comparables Distance")].count(false) >= 1 
